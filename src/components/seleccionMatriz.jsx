...
const DropdownsDinamicos = () => {
  ...
  const handleButtonClick = () => {
    if (!isBotonHabilitado) {
      // Mostrar la alerta si no se han seleccionado todas las opciones
      Swal.fire({
        icon: 'error',
        title: 'Oops...',
      ...
      // Si todo está bien, ejecutar la función para guardar en el almacenamiento local
      const seleccion = {
